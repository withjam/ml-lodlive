# Contributing to ml-lodlive

ml-lodlive welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use ml-lodlive, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][mlstack] to see if it has been answered there, and post your question there if not. Please tag it with MarkLogic, and AngularJS.
...
* **ml-lodlive Version** - is it a named version or from our master branch
...
Fork the project [on GitHub](https://github.com/withjam/ml-lodlive/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/ml-lodlive.git
$ cd ml-lodlive
$ git remote add upstream git://github.com/withjam/ml-lodlive.git
```
...
Go to https://github.com/username/ml-lodlive and select your feature branch. Click
...
[wiki]: https://github.com/withjam/ml-lodlive/wiki
[mlstack]: http://stackoverflow.com/questions/tagged/marklogic
[issue tracker]: https://github.com/withjam/ml-lodlive/issues
